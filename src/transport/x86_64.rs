...
impl Transport for HypPciTransport {
    ...
    fn read_device_features(&mut self) -> u64 {
        configwrite!(self.common_cfg, device_feature_select, 0);
        let device_features_low: u32 = configread!(self.common_cfg, device_feature);
        configwrite!(self.common_cfg, device_feature_select, 1);
    ...
    fn write_driver_features(&mut self, driver_features: u64) {
        configwrite!(self.common_cfg, driver_feature_select, 0);
        configwrite!(self.common_cfg, driver_feature, driver_features as u32);
        configwrite!(self.common_cfg, driver_feature_select, 1);
        configwrite!(
            self.common_cfg,
            driver_feature,
    ...
    fn queue_set(
        ...
        configwrite!(self.common_cfg, queue_enable, 1);
    }
